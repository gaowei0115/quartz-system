 ...
 * @desrciption:
 * @author: gaowei
 * @date： 2018-12-04 11:22
 * @history: (version) author date desc
 */
public class QuartzSchedulerFactoryBean extends SchedulerAccessor implements FactoryBean<Scheduler>, BeanNameAware,
    ...
    private void initSchedulerFactory(SchedulerFactory schedulerFactory)
        ...
        if (this.dataSource != null) {
            mergedProps.put(StdSchedulerFactory.PROP_JOB_STORE_CLASS, QuartzJobStoreSupport.class.getName());
        }

        // Make sure to set the scheduler name as configured in the Spring configuration.
        if (this.schedulerName != null) {
//            mergedProps.put(StdSchedulerFactory.PROP_SCHED_INSTANCE_NAME, this.schedulerName);
            mergedProps.put(StdSchedulerFactory.PROP_SCHED_INSTANCE_NAME, mergedProps.getProperty(StdSchedulerFactory.PROP_SCHED_INSTANCE_NAME));
        }
